...
<?php $themever = wp_get_theme(get_template()); $version = $themever["Version"]; ?>
    <ul class="anps-admin-menu">
        <li>
            ...
            <h2 class="hidden-sm hidden-md hidden-xs small_lh"><?php _e("Theme Options", 'construction'); ?><br/><span class="version"><?php echo esc_attr('version: '). esc_attr($version);?></span></h2>
        </li>
        <li>
        ...
        <li><a <?php if (isset($_GET['sub_page']) && $_GET['sub_page'] == "import_export_widgets") echo 'id="selected-menu-item"'; ?> href="themes.php?page=theme_options&sub_page=import_export_widgets"><i class="fa fa-file-code-o"></i><span class="hidden-sm hidden-xs hidden-md"><?php _e("Import/Export Widgets", 'construction'); echo wp_kses($notify, array("span"=>array("class"=>array())));?></span></a></li>
