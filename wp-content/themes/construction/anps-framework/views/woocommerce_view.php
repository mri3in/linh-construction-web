...
<form action="themes.php?page=theme_options&sub_page=woocommerce&save_woo" method="post">
    <div class="content-inner">
        ...
        <div class="row">
            ...
            <div class="input col-md-4">
                <?php $style->anps_create_checkbox('anps_product_zoom', esc_html__('Product image zoom', 'construction'), '1');?>
            </div>
            <div class="input col-md-4">
                <?php $style->anps_create_checkbox('anps_product_lightbox', esc_html__('Product image lightbox', 'construction'), '1');?>
            </div>
        </div>
    </div>
