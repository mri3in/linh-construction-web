...
<form action="themes.php?page=theme_options&sub_page=options_page&save_page" method="post">
    <div class="content-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 style="margin-bottom:0px;"><i class="fa fa-columns"></i><?php esc_html_e('Page Heading', 'construction'); ?></h3>
            </div>
           <!-- Enable/Disable page title and background -->
            <div class="col-md-6">
                <?php $style->anps_create_checkbox('anps_heading_status', esc_html__('Enable page heading and background', 'construction'), '1');?>
            </div>
             <!-- Breadcrumbs enable/disable -->
            <div class="col-md-6">
                <?php $style->anps_create_checkbox('anps_breadcrumbs_status', esc_html__('Enable breadcrumbs', 'construction'), '1');?>
            </div>
