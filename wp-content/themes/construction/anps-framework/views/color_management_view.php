...
<form action="themes.php?page=theme_options&save_style" method="post">
    <div class="content-inner">     
        ...
        <div class="row" id="anps_predefined_colors">
            <div class="col-md-12">
                <h3><i class="fa fa-tint"></i><?php esc_html_e('Predefined Color Schemes', 'construction'); ?></h3>
                <h4><?php esc_html_e('Choose a predefined color scheme', 'construction'); ?></h4>
                <p><?php esc_html_e("The schemes will replace the below colors with the predefined ones, which you can then edit as you like. Don't forget to save the color changes.", 'construction'); ?></p>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 ">
                <h3><i class="fa fa-tint"></i><?php esc_html_e("Button Colors", 'construction'); ?></h3>
            </div>
        </div>
        ...
        <div class="section button-wrap row">
            ...
            <div class="col-md-3 col-sm-6 btn-bg">
                <?php $style->anps_create_color_option('anps_normal_button_bg', 'fab702', esc_html__('Background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c">
                <?php $style->anps_create_color_option('anps_normal_button_color', 'ffffff', esc_html__('Text color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-bg-h">
                <?php $style->anps_create_color_option('anps_normal_button_hover_bg', 'ffcc43', esc_html__('Hover background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c-h">
                <?php $style->anps_create_color_option('anps_normal_button_hover_color', 'ffffff', esc_html__('Hover text color', 'construction')); ?>
            </div>
        </div>
        ...
        <div class="section button-wrap row">
            ...
            <div class="col-md-3 col-sm-6 btn-bg">
                <?php $style->anps_create_color_option('anps_gradient_button_bg', 'fab702', esc_html__('Background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c">
                <?php $style->anps_create_color_option('anps_gradient_button_color', 'ffffff', esc_html__('Text color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-bg-h">
                <?php $style->anps_create_color_option('anps_gradient_button_hover_bg', 'ffcc43', esc_html__('Hover background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c-h">
                <?php $style->anps_create_color_option('anps_gradient_button_hover_color', 'ffffff', esc_html__('Hover text color', 'construction')); ?>
            </div>
        </div>
        ...
        <div class="section button-wrap row">
            ...
            <div class="col-md-3 col-sm-6 btn-bg">
                <?php $style->anps_create_color_option('anps_dark_button_bg', '242424', esc_html__('Background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c">
                <?php $style->anps_create_color_option('anps_dark_button_color', 'ffffff', esc_html__('Text color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-bg-h">
                <?php $style->anps_create_color_option('anps_dark_button_hover_bg', 'ffffff', esc_html__('Hover background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c-h">
                <?php $style->anps_create_color_option('anps_dark_button_hover_color', '242424', esc_html__('Hover text color', 'construction')); ?>
            </div>
        </div>
        ...
        <div class="section button-wrap row">
            ...
            <div class="col-md-3 col-sm-6 btn-bg">
                <?php $style->anps_create_color_option('anps_light_button_bg', 'ffffff', esc_html__('Background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c">
                <?php $style->anps_create_color_option('anps_light_button_color', '242424', esc_html__('Text color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-bg-h">
                <?php $style->anps_create_color_option('anps_light_button_hover_bg', '242424', esc_html__('Hover background color', 'construction')); ?>
            </div>
            <div class="col-md-3 col-sm-6 btn-c-h">
                <?php $style->anps_create_color_option('anps_light_button_hover_color', 'ffffff', esc_html__('Hover text color', 'construction')); ?>
            </div>
        </div>
        ...
        <div class="section button-wrap row">
            ...
            <div class="col-md-6 col-sm-6 btn-c">
                <?php $style->anps_create_color_option('anps_minimal_button_color', 'fab702', esc_html__('Text color', 'construction')); ?>
            </div>
            <div class="col-md-6 col-sm-6 btn-c-h">
                <?php $style->anps_create_color_option('anps_minimal_button_hover_color', 'ffcc43', esc_html__('Hover text color', 'construction')); ?>
            </div>
        </div>
    </div>          
