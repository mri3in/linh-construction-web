            ...
            <div class="global-layout">
                ...
                <div class="options-to-toggle">
                    ...
                    <div class="col-md-12 show-classic-layout onoff">
                        ...
                        <h4><?php printf(esc_html__('Set Your %s Home Page %s Menu Options', 'construction'), '<span>', '</span>');?></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="options-to-toggle">
                                ...
                                <div class="col-md-4 onoff show-top show-bottom">
                                    <?php
                                    $menu_positions = array(
                                        2 => esc_html__('Left', 'construction'),
                                        1 => esc_html__('Center', 'construction'),
                                        3 => esc_html__('Right', 'construction'),
                                    );
                                    $options->anps_create_select('anps_front_menu_center', $menu_positions, esc_html__('Menu position', 'construction'));
                                    ?>
                                </div>
                        ...
                        <div class="row global-options">
                            ...
                            <div class="col-md-12 ">
                                <h4><?php printf(esc_html__('Set Your %s Global Menu %s Options', 'construction'), '<span>', '</span>'); ?></h4>
                            ...
                            <div class="col-md-6 hideifstyle4">
                                ...
                                $options->anps_create_select('anps_global_menu_center', $menu_positions, esc_html__('Menu position', 'construction'));
                                ?>
                            </div>
                    ...
                    <div class="col-md-12 show-vertical-layout onoff">
                        ...
                        <h3><i class="fa fa-bars"></i><?php esc_html_e('Set Your Global Menu Vertical Options', 'construction'); ?></h3>
